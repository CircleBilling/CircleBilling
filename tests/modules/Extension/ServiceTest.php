...
class ServiceTest extends \BBTestCase {
    ...
    public function testdownloadAndExtractTranslationException()
    {
        ...
        $this->service->setDi($di);
        $this->setExpectedException('\Box_Exception', 'Extension can not be moved. Make sure your server write permissions to locale folder.', 440);
    ...
    public function testdownloadAndExtractThemeTypeException()
    {
        ...
        $this->service->setDi($di);
        $this->setExpectedException('\Box_Exception', 'Extension can not be moved. Make sure your server write permissions to themes folder.', 439);
    ...
    public function testdownloadAndExtractRenameException()
    {
        ...
        $this->service->setDi($di);
        $this->setExpectedException('\Box_Exception', 'Extension can not be moved. Make sure your server write permissions to modules folder.', 437);
